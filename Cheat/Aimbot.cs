...
namespace ExSharpBase.Cheat
{
    public static class Aimbot
    {
        ...
        public static float raduisFov = 100;
        ...
        public static void AimToTarget()
        {
            ...
            SetViewAngles(Main.cameraManager.CameraCache.POV.Rotation + idealAngDelta /5);//Engine.cameraManager.CameraCache.POV.Rotation + (idealAngDelta));
        }
